<template>
  ...
  <div class="content">
    <div v-if="yep">
      <h1>Super !</h1>
      <p>
        Envoi-moi un snap : <b>tw.ik</b>. <br />
        Tu peux aussi m'envoyer un mail si t'es kéblo en 2014 : <b>etienne.dldc@outlook.fr</b>.
      </p>
    ...
    <div class="partage-button">
      <my-button label="Yeah !" @go="nextStep"></my-button>
    </div>
  </div>
</template>
